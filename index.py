...
button = tk.Button(text="AVVIA", command=partial(creazione_pg.pagina_nome_pg, pagina_iniziale), font=("Helvetica", 20), background=v.bg, foreground=v.colore_titolo, height=2, width=20)
button.pack()
